...
{
    const string privateCode = "3aTjDPBYIk6NGCKtfolZNQvrsXSaVONUud4xk4Kxb-xg";  //Key to Upload New Info
    const string publicCode = "61eb455c8f40bb1244fdc32c";   //Key to download
